	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(img/store.jpg);">
					<span class="login100-form-title-1">
						Login
					</span>
				</div>
				<?php //include "detail.php"; ?>
				<form class="login100-form validate-form" method="post" action="admin/action/proses-login.php">
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" ><i class="fa fa-key"></i>&nbsp; Login
						</button>
					</div>

					<div class="flex-sb-m w-full p-b-30" style="padding-top: 15px">
						<div style="font-weight: 6px;">Jika belum punya akun, Silahkan </div>
						<b><a class="btn btn-primary" href="registrasi.php" ><i class="fa fa-list"></i> Registrasi</font></a></b>
					</div>
